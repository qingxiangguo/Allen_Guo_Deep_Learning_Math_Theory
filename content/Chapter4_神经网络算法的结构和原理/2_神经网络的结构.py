...
大多数优化算法最原始的动机都是试图获取代价函数对应的精确梯度，从而优化学习器。但在实践中，我们经常使用含有噪声的梯度进行优化。
...
h1: 输入信号 = x1w11 + x2w12 + x3w13 + b1 = 120*0.1 + 172*0.2 + 28*0.3 + 0.4 = 55.2,
 输出值 = sigmoid(55.2) = 1
...
输出层:
输入信号 = h5*w81 + h6*w82 + h7*w83 + b8 = 0.9999*3.2 + 0.9999*3.3 + 1*3.4 + 3.5 = 13.39
输出值 = sigmoid(13.39) = 0.9999
