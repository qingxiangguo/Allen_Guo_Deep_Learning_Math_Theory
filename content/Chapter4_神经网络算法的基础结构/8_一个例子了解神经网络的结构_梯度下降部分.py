...
个神经网络的例子吗，一个简单的有两个隐藏层的神经网络示例，这个神经网络可以通过输入的，体重，身高，年龄三个数据，
...
首先，初始化所有参数。在上述例子中，有以下参数：w11, w12, w13, b1, w21, w22, w23, b2, w31, w32, w33, b3, w41, w42, w43, b4, w51, w52, w53, w54, b5, w61, w62, w63, w64, b6, w71, w72, w73, w74, b7, w81, w82, w83, b8。

对于每一次迭代，对于三个样本（person1, person2, person3）分别进行正向传播，计算出每个样本的预测输出，然后计算出每个样本的损失函数值（可以使用二分类交叉熵损失函数）。
